...
export default function App() {
  ...
  // URL-based routing - /crm for secretaria, everything else for portal
  const isCRM = window.location.pathname === "/crm" || window.location.pathname === "/crm/";

  if (isCRM) return <CRM {...shared} />;
...
//  CRM
// ═══════════════════════════════════════════════════════════
function CRM({clientes,historial,citas,setCitas,mant,twilio,setTwilio}) {
...
//  PORTAL CLIENTE
// ═══════════════════════════════════════════════════════════
function Portal({clientes,setClientes,historial,citas,setCitas,mant,twilio}) {
